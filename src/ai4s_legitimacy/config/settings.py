...
QUALITY_V4_CHECKPOINT = OUTPUTS_DIR / "reports" / "freeze_checkpoints" / "quality_v4_freeze_checkpoint.json"
QUALITY_V4_PAPER_RESULTS = OUTPUTS_DIR / "reports" / "paper_materials" / "paper_results_snapshot.md"
RESEARCH_DB_SUMMARY_PATH = FREEZE_CHECKPOINTS_DIR / "research_db_summary.json"
QUALITY_V4_CONSISTENCY_REPORT_PATH = FREEZE_CHECKPOINTS_DIR / "quality_v4_consistency_report.json"
